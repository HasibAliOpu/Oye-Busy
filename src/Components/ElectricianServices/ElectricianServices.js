    ...
    <div className="flex pl-8 mb-10 mt-20">
      ...
      <div className="grid grid-cols-6 gap-5 p-20">
        <div className="p-3 text-center rounded-2xl shadow-xl hover:scale-110 ease-in-out duration-500 bg-gradient-to-r hover:from-[#FFA500] hover:to-[#FFECCA]">
          <img className="-mt-20" src={fuse} alt="" />
          <p className="font-semibold ">MCB & Fuse</p>
          <p className="text-sm text-[#757575]">Repairing & Installation</p>
        </div>
        <div className="p-3 text-center rounded-2xl shadow-xl hover:scale-110 ease-in-out duration-500 bg-gradient-to-r hover:from-[#FFA500] hover:to-[#FFECCA]">
          <img className="mx-auto -mt-20" src={switches} alt="" />
          <p className="font-semibold ">Switch & Socket</p>
          <p className="text-sm text-[#757575]">
            Shower, Faucets & Holder <br /> Installation & Repair
          </p>
        </div>
        <div className="p-3 text-center rounded-2xl shadow-xl hover:scale-110 ease-in-out duration-500 bg-gradient-to-r hover:from-[#FFA500] hover:to-[#FFECCA]">
          <img className="mx-auto -mt-20" src={wiring} alt="" />
          <p className="font-semibold ">Wiring</p>
          <p className="text-sm text-[#757575]">
            Toilet pot, Sink ,<br />
        ...
        <div className="p-3 text-center rounded-2xl shadow-xl hover:scale-110 ease-in-out duration-500 bg-gradient-to-r hover:from-[#FFA500] hover:to-[#FFECCA]">
          <img className="mx-auto -mt-20" src={appliances} alt="" />
        ...
        <div className="p-3 text-center rounded-2xl shadow-xl hover:scale-110 ease-in-out duration-500 bg-gradient-to-r hover:from-[#FFA500] hover:to-[#FFECCA]">
          <img className="mx-auto -mt-20" src={chandelier} alt="" />
          <p className="font-semibold ">Chandelier</p>
          <p className="text-sm text-[#757575]">
            Holder, Hanger, Rod <br /> Installation
          </p>
        </div>
        <div className="p-3 text-center rounded-2xl shadow-xl hover:scale-110 ease-in-out duration-500 bg-gradient-to-r hover:from-[#FFA500] hover:to-[#FFECCA]">
          <img className="-mt-20" src={doorBell} alt="" />
          <p className="font-semibold ">Door Bell</p>
